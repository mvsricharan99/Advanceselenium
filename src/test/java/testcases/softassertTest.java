...
import Excelfileutility.readdatafromexcel;
	...
	public class softassertTest extends BaseClass
	{
	@Test(groups = "Smoke")
	public void createcampaign() throws EncryptedDocumentException, IOException, InterruptedException
	{
     ...
     // Verify toast message using regex or contains
        SoftAssert soft = new SoftAssert();
        soft.assertTrue(msg.startsWith("Campaign " + baseName), "Toast message doesn't start with input name");
        soft.assertTrue(msg.contains("Successfully Added"), "Toast missing success text");
